    ...
    internal class Entry
    {
        ...
        public static void OnLoad(EventArgs args)
        {
            try
            {
                deaths = new[]
                         {
                             "/all mouse broke wtf", "LOL", ":(", "/all stop ddosing me", "help?!", "wtf", "....", "/all this team...",
                             "/all report my team", "no way to carry", "riot fix your game", "that shit is op",
                             "/all report ing you for cheating..", "how can i win this game?!", "ResidentSleeper", "dumb champions", "/all fix your champs riot"
                         };
                ...
                ShowNotification("FeedingWarfare by WarfareLoL - Loaded", Color.Crimson, 10000);
        ...
        {
            Game.Say("/all broken champs broken game");
        ...
        #region Notifications Credits to iMeh.
